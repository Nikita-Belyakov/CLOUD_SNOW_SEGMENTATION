...
- **ATTENTION!** Splitting all inference data requires about **4 GB** of free memory on your drive
...
- There are lots of parameters and paths and names of models to save! Be careful with it! You can adjust several parameters ot training as:
  - `learning rate`
  - `weight decay`
